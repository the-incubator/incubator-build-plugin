...
- **Suggested next step** — single sentence: file an issue, open `inc:debug`, or escalate to extensive analysis if more issues surfaced.
...
- No automatic handoff to `inc:plan`. The quick path ends with the bug report.
