---
name: inc-best-practices-researcher
...
2. **Identify Relevant Skills**:
   Match the research topic to whichever skills are discoverable in the current environment. Use the descriptions in each `SKILL.md` to decide relevance; do not hard-code skill names here, since the available skill set varies by environment.
