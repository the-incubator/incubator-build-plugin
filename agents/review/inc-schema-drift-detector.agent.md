---
name: inc-schema-drift-detector
...
- Run `inc-schema-drift-detector` first to ensure clean schema
- Then run `inc-data-migration-expert` for migration logic review
- Then run `inc-data-integrity-guardian` for integrity checks
