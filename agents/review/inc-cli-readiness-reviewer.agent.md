---
name: inc-cli-readiness-reviewer
...
- **Agent-native parity concerns** -- whether UI actions have corresponding agent tools. That is the inc-agent-native-reviewer's domain, not yours.
